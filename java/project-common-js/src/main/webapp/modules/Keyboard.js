 ...
 */
VvWork.Keyboard = function(element) {

    /**
     * Reference to this VvWork.Keyboard.
     * @private
     */
     ...
     * with this VvWork.Keyboard in focus.
     * 
     * @event
     ...
     * @private
     * @constructor
     * @augments VvWork.Keyboard.KeyEvent
     ...
     */
    this.modifiers = new VvWork.Keyboard.ModifierState();
    ...
    var update_modifier_state = function update_modifier_state(e) {
        ...
        // Get state
        var state = VvWork.Keyboard.ModifierState.fromKeyboardEvent(e);
 ...
 * @constructor
 */
VvWork.Keyboard.ModifierState = function() {
 ...
 * @returns {VvWork.Keyboard.ModifierState} The current state of keyboard
 *                                             modifiers.
 */
VvWork.Keyboard.ModifierState.fromKeyboardEvent = function(e) {
    
    var state = new VvWork.Keyboard.ModifierState();
