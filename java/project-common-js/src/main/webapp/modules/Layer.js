 ...
 */
VvWork.Layer = function(width, height) {
    ...
    /**
     * Map of all VvWork channel masks to HTML5 canvas composite operation
    ...
    this.transfer = function(srcLayer, srcx, srcy, srcw, srch, x, y, transferFunction) {
        ...
        for (var i=0; i<srcw*srch*4; i+=4) {
            ...
            var src_pixel = new VvWork.Layer.Pixel(
                src.data[i],
                src.data[i+1],
                src.data[i+2],
                src.data[i+3]
            ...
            var dst_pixel = new VvWork.Layer.Pixel(
                dst.data[i],
                dst.data[i+1],
                dst.data[i+2],
                dst.data[i+3]
 ...
 */
VvWork.Layer.ROUT  = 0x2;

/**
 * Channel mask for the composite operation "atop".
 */
VvWork.Layer.ATOP  = 0x6;

/**
 * Channel mask for the composite operation "xor".
 */
VvWork.Layer.XOR   = 0xA;

/**
 * Channel mask for the composite operation "rover".
 */
VvWork.Layer.ROVER = 0xB;

/**
 * Channel mask for the composite operation "over".
 */
VvWork.Layer.OVER  = 0xE;

/**
 * Channel mask for the composite operation "plus".
 */
VvWork.Layer.PLUS  = 0xF;
 ...
 */
VvWork.Layer.Pixel = function(r, g, b, a) {
