...
/**
 * An object used by the VvWork client to house arbitrarily-many named
 * input and output streams.
 * 
 * @constructor
 * @param {VvWork.Client} client
 *     The client owning this object.
 *
 * @param {Number} index
 *     The index of this object.
 */
VvWork.Object = function vvWorkObject(client, index) {

    /**
     * Reference to this VvWork.Object.
     *
     * @private
     * @type {VvWork.Object}
     */
     ...
     *
     * @event
     * @param {VvWork.InputStream} inputStream
     ...
     *     is received. This callback will be provided a VvWork.InputStream
 ...
 * @type {String}
 */
VvWork.Object.ROOT_STREAM = '/';

/**
 * The mimetype of a stream containing JSON which maps available stream names
 * to their corresponding mimetype. The root stream of a VvWork.Object MUST
 * have this mimetype.
 *
 * @constant
 * @type {String}
 */
VvWork.Object.STREAM_INDEX_MIMETYPE = 'application/vnd.vvwork.stream-index+json';
